                    ...
                    >
                        ...
                        <View style={styles.circleProgressView}>
                            ...
                            >
                                {
                                    (fill) => (
                                        <Text style={styles.numberInside}>80%</Text>
                                    )
                                }
                            </AnimatedCircularProgress>
                        </View>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate("Usuario")}>
                                <View>
                                    <View style={styles.box}>
                                        <MaterialIcons style={styles.iconRegistered} name="lock-clock" size={70} color="#ef476f" />
                                        <View style={styles.textos}>
                                            <Text style={styles.rText}>Total de Viajens</Text>
                                            <Text style={styles.lenghtText}>{dados.total_usuarios}</Text>
                                        </View>
                                    </View>
                                    <Text style={styles.textFooter}>Viajens Marcada</Text>
                                </View>
                            </TouchableOpacity>
